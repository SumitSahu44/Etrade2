    ...
    <div className="py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="bg-slate-900 text-white p-4 flex items-center gap-3 mb-8">
          ...
          <p className="text-[11px] font-bold uppercase st">Members are advised to download and review the latest FY 2026-27 trade guidelines.</p>
        </div>
            ...
            <div key={i} className="py-8 flex flex-col md:flex-row justify-between items-start md:items-center group cursor-pointer hover:bg-slate-50 transition px-4">
              <div className="flex gap-6 items-center">
                ...
                <div>
                  ...
                  <div className="flex gap-4 text-[10px] font-black text-slate-400 uppercase st">
                    <span>Ref: {n.ref}</span>
                    <span>Date: {n.date}</span>
                  </div>
                </div>
              </div>
              <div className="mt-4 md:mt-0 flex items-center gap-2 text-blue-600 font-black text-xs uppercase st group-hover:translate-x-2 transition-transform">
