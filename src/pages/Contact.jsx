        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm">+91-XXXXXXXXXX</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm">e-trade@parekhtrade.com</p>
                </div>
              </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100">
            ...
            <form className="space-y-4">
              ...
              <button className="w-full bg-slate-900 text-white py-3 rounded-lg font-bold hover:bg-blue-600 transition-all duration-300 uppercase tracking-wider shadow-md hover:shadow-lg">
                Book Appointment
              </button>
